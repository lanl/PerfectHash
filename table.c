...
int main(int argc, char *argv[])
{
   ...
   double density_avg = (density_axis[density_axis_size-1]+density_axis[0])/2.0;
   double temp_avg = (temp_axis[temp_axis_size-1]+temp_axis[0])/2.0;

   double density_stddev = (density_axis[density_axis_size-1]-density_axis[0])/6.0;
   double temp_stddev = (temp_axis[temp_axis_size-1]-temp_axis[0])/6.0;

   for (i=1; i<density_axis_size; i++){
      density_axis[i] = density_axis[0]+(double)i*density_increment;
   }

   for (i=1; i<temp_axis_size; i++){
